...
**Labache, L.**, Petit, L., Joliot, & Zago, L. (2022). Brain lateralized
networks of visuospatial attention evidenced by line bisection
task-related, resting-state intrinsic connectivity and graph theory
analyses in 130 healthy right-handers.
...
<p align="center">
<img src="readme_files/ALANs_networks.png" width="80%" height="80%" />
</p>
...
-   `ALANs_description.csv`: CSV file containing a full description of
    ...
    *Network* corresponded to which of the 5 networks a region belongs.
